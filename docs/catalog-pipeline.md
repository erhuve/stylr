...
Post-deployment continuation, September 16: the 3,086-photo release is privately deployed and verified. A further 117 directly reviewed candidates yield 53 photos, 50 build observations and no complete references, reaching 3,139 repository photos and 202 complete references. Additions include 22 masculine-styled, 19 feminine-styled and 12 neutral outfits. Five bound listing snapshots preserve all 1,162 product decisions. See `docs/verification/postdeploy-sourcing.md` for current deployment and verification status. All earlier records below describe historical batches.

Three-thousand-photo continuation, September 16: twelve WEAR/Tokyo Fashion batches directly review 1,257 candidates on 58 bound sheets, with eleven original-image enlargements. They admit 1,116 photos across 1,116 new source pages, 378 build observations and two complete references. Repository totals are 3,086 photos, 202 complete references and 38 unchanged broader-build example matches. All 3,086 photos have image-bound presentation reviews; additions are 367 masculine, 347 feminine, 82 mixed and 320 unclear. Every prior record/order/hash is preserved. `research/catalog/collect_street_batch.py` records bounded archive/listing snapshots, account caps, decisions, duplicates and failures. See `docs/verification/three-thousand-sourcing.md`; deployment remains pending. Earlier results below are historical.

Latest interactive menswear continuation: 153 candidates directly reviewed; 40 photos admitted from three new sources, with 34 build observations and no complete references. Repository totals are 1,970 photos, 200 complete references and 38 example matches. Presentation additions are 26 masculine and 14 neutral/unclear. Three bounded listing snapshots and 40 alternate-gallery decisions are recorded; 33 filename-selected candidates were visually inspected before labeling. Prior committed records remain unchanged. See `docs/verification/afternoon-sourcing.md` and batch `2026-09-16T2045-menswear` for provenance and limitations. Deployment remains pending. Earlier results below are historical.

Scheduled 4 p.m. run, September 16: 119 candidates directly reviewed on ten bound sheets with nine enlarged rereads and nine prior-image comparison pairs. Two batches add 58 photos across 51 new pages, 55 build observations and one complete reference. Current repository totals: 1,930 photos, 200 complete references and 38 example matches. Presentation additions are 16 masculine, 20 feminine, one mixed and 21 unclear; none of the new masculine looks supports all three body axes. All previous records, ordering and hashes remain unchanged. Source inventory: 1,572 sampled pages and 1,249 deferred URLs. No deployment. The following paragraphs preserve earlier release history.
