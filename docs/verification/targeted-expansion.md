...
Deployment verification is recorded after the private service is updated. Local photo screenshots and original corpora remain ignored; no photos or model weights are committed.
