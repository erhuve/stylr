...
Current catalog (2026-09-16, post-deployment continuation): 3,139 photos and 202 complete three-axis references. The 3,086-photo release was privately deployed and verified, then 117 additional candidates yielded 53 photos from ONE BONE, Wildfang, Tombolo and Snag; the broader-build example remains at 38 matches. `docs/verification/postdeploy-sourcing.md` records the latest verification and deployment status. `data/sourcing/README.md` documents sampled and deferred pages, provenance and source yields. The earlier archive pass is recorded in `docs/verification/three-thousand-sourcing.md`. Offline sourcing and clustering code lives in `research/`; see `research/README.md`.
