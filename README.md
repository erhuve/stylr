...
Presentation audit: all 7,125 repository images reviewed; 1,192 masculine, 4,006 feminine, 168 mixed/androgynous and 1,759 unclear outfits. `data/presentation/coverage.md` records source/build coverage and complete references. These are styling observations, not gender or unique-model counts. Future sourcing prioritizes extensive coverage of both presentations, particularly fuller-build masculine outfits with visible contours; exact parity is not required.

Current repository catalog (2026-09-17): 7,125 photos and 290 complete three-axis references. Sixteen reviewed batches add 2,019 photos from 2,890 candidates, including 29 complete references. The broader-build benchmark rises from 52 to 54 matches; the latest 57 additions supply one complete masculine-styled reference and no new benchmark matches. The requested doubling target is 10,212 admitted photos and remains in progress. These additions are not deployed: the last verified private live release remains 3,139 photos and 202 complete references. `docs/verification/doubling-sourcing.md` is the active continuation; `docs/verification/postdeploy-sourcing.md` records the live release. `data/sourcing/README.md` documents sampled and deferred pages, provenance and source yields. Offline sourcing and clustering code lives in `research/`; see `research/README.md`.
...
The repository library contains **7,125 color references**: the original 385 unchanged photographs plus 6,740 admitted outfit photographs from 9,685 reviewed candidates. The latest archive/retail continuation adds five masculine-styled, 31 feminine-styled, two mixed and 19 unclear outfits; hidden body traits remain unknown. The old 831-image archive backlog is fully reviewed. The remaining 3,768 training-archive candidates are explicitly pending and excluded from admission. Reviewed partial and seated photos are retained as detail views. The interface preloads only the current and two upcoming images. See `docs/catalog-pipeline.md` for sourcing, visual review, research history, reproducible admission and repository organization.
