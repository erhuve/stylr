...
The repository library contains **1,970 color references**: the original 385 unchanged photographs plus 1,585 admitted outfit photographs from 2,283 reviewed candidates. The latest batch reviewed 153 new candidates, admitting 40 photos across 39 new source pages and no complete three-axis references. It adds 26 masculine-styled outfits and 14 neutral/unclear outfits; hidden body traits remain unknown. Reviewed partial and seated photos are retained as detail views. The interface preloads only the current and two upcoming images. See `docs/catalog-pipeline.md` for sourcing, visual review, research history, reproducible admission and repository organization.
