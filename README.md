...
The repository library contains **1,930 color references**: the original 385 unchanged photographs plus 1,545 admitted outfit photographs from 2,130 reviewed candidates. The latest two batches reviewed 119 new candidates, admitting 58 photos across 51 new source pages and one complete three-axis reference. Reviewed partial and seated photos are retained as detail views. The interface preloads only the current and two upcoming images. See `docs/catalog-pipeline.md` for sourcing, visual review, research history, reproducible admission and repository organization.
