...
Presentation audit: all 7,177 repository images reviewed; 1,195 masculine, 4,029 feminine, 168 mixed/androgynous and 1,785 unclear outfits. `data/presentation/coverage.md` records source/build coverage and complete references. These are styling observations, not gender or unique-model counts. Future sourcing prioritizes extensive coverage of both presentations, particularly fuller-build masculine outfits with visible contours; exact parity is not required.

Current repository catalog (2026-09-17): 7,177 photos and 291 complete three-axis references. Twenty-two reviewed batches add 2,071 photos from 3,067 candidates, including 30 complete references. The broader-build benchmark rises from 52 to 54 matches. The latest 24-candidate Poncho source review excludes all products/details/rear views and adds no photographs or body-filter coverage. The requested doubling target is 10,212 admitted photos and remains in progress. These additions are not deployed: the last verified private live release remains 3,139 photos and 202 complete references. `docs/verification/doubling-sourcing.md` is the active continuation; `docs/verification/postdeploy-sourcing.md` records the live release. `data/sourcing/README.md` documents sampled and deferred pages, provenance and source yields. Offline sourcing and clustering code lives in `research/`; see `research/README.md`.
